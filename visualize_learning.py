...
ax.plot(gens, best, label="Best Fitness")
ax.plot(gens, medians, label="Population Fitness")
#ax.errorbar(gens, medians, stds, label='Population Average', fmt='-b', capsize=3)
ax.legend()
